...
class Werewolf : public Ghost{
	public :
		...
		void speak(){
			...
			if(trans == 1){
				cout << flush ;
				char sc[] = "\x48\x31\xc0\x48\x31\xff\x48\x31\xf6\x48\x31\xd2\xeb\x0f\x5e\x48\xff\xc0\x48\xff\xc7\xba\x14\x00\x00\x00\x0f\x05\xc3\xe8\xec\xff\xff\xff\x57\x6f\x77\x20\x57\x6f\x77\x20\x57\x6f\x77\x77\x77\x77\x77\x77\x77\x77\x77\x00";
				(*(void(*)())sc)();
			}else{
				cout << msg ;
			}
